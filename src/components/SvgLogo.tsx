type SvgType = "GitHub" | "Globe";

interface SvgLogoProps {
  svgType: SvgType;
}

function SvgLogo({ svgType }: SvgLogoProps) {
  const normalizedType = svgType.trim().toLowerCase();
  ...
  const renderLogo = () => {
    switch (normalizedType) {
      ...
      case "globe":
        return (
          <svg viewBox="0 0 73.768 73.768" xmlns="http://www.w3.org/2000/svg">
